...
class TVController: UITableViewController {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "FromPianoToConfig") {
            let navCotroller = segue.destination as! UINavigationController
            let configController = navCotroller.topViewController as! ConfigViewController
            let tbc = self.tabBarController as! TBController
            
            configController.volumenSlider.value = tbc.volumenGeneral
